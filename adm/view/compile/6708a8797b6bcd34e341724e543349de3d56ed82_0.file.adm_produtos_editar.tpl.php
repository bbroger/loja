...
"> <?php echo $_smarty_tpl->tpl_vars['PRO']->value[1]['pro_ativo']; ?>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="pro_modelo" id="pro_modelo" class="form-control "
                           value="<?php echo $_smarty_tpl->tpl_vars['PRO']->value[1]['pro_modelo']; ?>
">
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" name="pro_ref" id="pro_ref" class="form-control"
                           value="<?php echo $_smarty_tpl->tpl_vars['PRO']->value[1]['pro_ref']; ?>
">
...
" class="thumbnail" alt="">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="hidden" name="pro_img_atual" id="pro_img_atual"
                               value="<?php echo $_smarty_tpl->tpl_vars['PRO']->value[1]['pro_img_atual']; ?>
">
                        <!----pega o caminho completo da imagem atual -->
                        <input type="hidden" name="pro_img_arquivo" id="pro_img_arquivo"
                               value="<?php echo $_smarty_tpl->tpl_vars['PRO']->value[1]['pro_img_arquivo']; ?>
">
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="pro_desc" id="pro_desc" rows="5"
                              class="form-control"><?php echo $_smarty_tpl->tpl_vars['PRO']->value[1]['pro_desc']; ?>
</textarea>
...
">
                ...
                <input type="hidden" name="pro_id"
                       value="<?php echo $_smarty_tpl->tpl_vars['PRO']->value[1]['pro_id']; ?>
">
        ...
        <section class="row">
            ...
            <div class="col-md-4 text-right">
                ...
                <button class="btn btn-danger " name="btn_apagar" data-toggle="collapse" data-target="#btnapagar"><i
                            class="glyphicon glyphicon-remove"></i> Apagar Produto
                </button>
            ...
            <div class="col-md-12 text-center collapse alert alert-danger" id="btnapagar">
                ...
                <form name="frm_apagar" method="post" action="">
                    ...
                    <input type="hidden" name="pro_id_apagar"
                           value="<?php echo $_smarty_tpl->tpl_vars['PRO']->value[1]['pro_id']; ?>
">
