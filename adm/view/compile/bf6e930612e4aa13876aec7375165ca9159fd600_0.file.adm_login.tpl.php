<?php
/* Smarty version 3.1.31, created on 2019-09-26 11:03:43
  from "C:\wamp64\www\loja\adm\view\adm_login.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array(
    'version' => '3.1.31',
    'unifunc' => 'content_5d8cc53f9da4a3_56138362',
    ...
    function content_5d8cc53f9da4a3_56138362(Smarty_Internal_Template $_smarty_tpl)
    {
        ?>
        <!DOCTYPE html>
            ...
            <section class="row">
                ...
                <div class="col-md-4 thumbnail" id="bloco_login_adm">
                    ...
                    <form name="login" method="post" action="">
                        ...
                        <br>
                        <br>
                        <button class="btn btn-success btn-block btn-lg" name="txt_logar" value="txt_logar"> Entrar
                        </button>
                        <br>
                    ...
                    <br>
                    <center>
                        <button class="btn btn-warning" data-toggle="collapse" data-target="#recovery"> Esqueci a
                            senha
                        </button>
